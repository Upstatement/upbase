...
var dn = (0, _es6Denodeify2['default'])(_es6Promise.Promise);

var copy = dn(_fsExtra2['default'].copy);
var renderFile = dn(_swig2['default'].renderFile);
var writeFile = dn(_fs2['default'].writeFile);
...
exports['default'] = function (dest, ctx) {
  ...
  (0, _sassdocExtras2['default'])(ctx, 'description', 'markdown', 'display', 'groupName', 'shortcutIcon', 'sort');
